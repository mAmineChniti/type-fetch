 ...
 */
export type Result<T, E = TFetchError> = {
    data: T | null;
    error: E | null;
};
/**
 ...
 */
export declare class TFetchError extends Error {
    readonly statusCode?: number | undefined;
    constructor(message: string, statusCode?: number | undefined);
}
export declare const DEFAULT_RETRY_COUNT = 0;
export declare const DEFAULT_RETRY_DELAY = 1000;
export declare const DEFAULT_MAX_CACHED_ENTRIES = 5000;
/**
